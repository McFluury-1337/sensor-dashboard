...
**Статус на сейчас: код готов, сам хостинг ещё не развёрнут** — см. раздел «Что ещё не готово» ниже.
...
- Хостинг на Beget по [RUNBOOK.md](harness/stage-6/RUNBOOK.md) — код готов, аккаунт и деплой ещё не сделаны.
- Отсюда: живой ссылки с HTTPS пока нет, недельный аптайм (требование этапа хостинга) не может быть подтверждён, пока сайт не развёрнут.

Всё остальное — локальный запуск, тесты, API, админка, внешний вид — сделано и проверено, детали в `harness/stage-N/REPORT.md`.
